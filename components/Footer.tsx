    ...
    <footer className="text-gray-600 body-font pt-20 bg-black lg:mx-20">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          ...
          >
            <svg fill="currentColor" className="w-5 h-5" viewBox="0 0 24 24">
              <path d="M19 0h-14C2.2 0 0 2.2 0 5v14c0 2.8 2.2 5 5 5h14c2.8 0 5-2.2 5-5V5c0-2.8-2.2-5-5-5zM7.1 19H4.5V9h2.6v10zm-1.3-11.2c-.8 0-1.3-.6-1.3-1.3 0-.7.5-1.3 1.3-1.3s1.3.6 1.3 1.3c0 .7-.5 1.3-1.3 1.3zm13.2 11.2h-2.6v-5.3c0-1.3-.5-2.1-1.6-2.1-.9 0-1.4.6-1.6 1.1-.1.2-.1.4-.1.7V19h-2.6s.1-8.6 0-9.5h2.6v1.3c.3-.5 1-1.3 2.4-1.3 1.7 0 3 1.1 3 3.5V19z" />
            </svg>
          </a>
        </span>
      </div>
